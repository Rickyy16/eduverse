    ...
    return (
        <BrowserRouter>
            <Routes>
                ...
                <Route path="/dashboard" element={userId && database === "https://major-project-clg-81254-default-rtdb.firebaseio.com" ? <Dashboard name={userName} handleCallBack={callBack} log={log} /> : <Navigate to="/" />} />
            </Routes>
        </BrowserRouter>
    )
}
